                ...
                map<string, shared_ptr<Student>>& students)
{
    ...
    for ( auto& info_pair : students )
    {
        file_object << (info_pair.second)->student_number << ";"
                    << info_pair.second->user_id << ";"
                    << info_pair.second->name << ";"
                    << info_pair.second->phone_number << ";"
                    << info_pair.second->email << ";"
                    << info_pair.second->skype << endl;
        // TODO; print out rest of the info
    }
    ...
    while( true ) {
        ...
        // Changing student data
            ...
            if ( student_numbers.find(id) != student_numbers.end() )
            {
                ...
                /*else
                {
                    cout << "Erroneous phone number!" << endl << endl;
                }*/
            }
            else
            {
                cout << "There is no studnet with the given number!"
                     << endl << endl;
            }
